...
import desktopApp.ui.controllers.KitapController;
...
public class KitapPage {
	...
	public void show(Kitap kitap) {
		try {
			...
			FXMLLoader loader = new FXMLLoader(getClass().getResource(templatePath + "/Kitap.fxml"));
			
			applicationContext = DesktopApplication.applicationContext;
			loader.setControllerFactory(applicationContext::getBean);
			AnchorPane root = (AnchorPane)loader.load();
			KitapController kitapController = loader.getController();
			kitapController.setKitap(kitap);
